...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
    ...
    if (isset($_POST['id'])) {
        ...
        $update = mysqli_query($mysqli, "UPDATE tbl_antrian SET status='$status', updated_date='$updated_date' WHERE id='$id'") or die('Ada kesalahan pada query update : ' . mysqli_error($mysqli));
    }
}
